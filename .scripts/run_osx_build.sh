...
validate_recipe_outputs "terraform-provider-gitlab-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="terraform-provider-gitlab-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi